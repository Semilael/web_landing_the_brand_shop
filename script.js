document.addEventListener('DOMContentLoaded', () => {
    (async () => {
        try {
            ...
            updateCartItemsSection(cartItemsBox, cartSpan, cartItems, cartItemsSection);
            ...
            addBtns.forEach((button) => {
                button.addEventListener('click', () => {
                    ...
                    if (product) {
                        addToCart(cartItems, product, productId);
                        updateCartItemsSection(cartItemsBox, cartSpan, cartItems, cartItemsSection);
                    }
...
function addToCart(cartItems, product, productId) {
...
function updateCartItemsSection(cartItemsBox, cartSpan, cartItems, cartItemsSection) {
        ...
        cartItems.forEach((item) => {
            ...
            <div class="product__content">
                ...
                <div class="product__desc">
                    ...
                    <p class="product__price_label">Price: 
